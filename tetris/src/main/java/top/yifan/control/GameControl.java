...
import top.yifan.config.DataInterfaceConfig;
import top.yifan.config.GameConfig;
import top.yifan.dao.Data;
...
import top.yifan.window.GameFrame;
import top.yifan.window.GamePanel;
import top.yifan.window.GamePointsSaveFrame;
import top.yifan.window.GameSettingFrame;
...
public class GameControl {
    ...
    public GameControl() {
        ...
        // 初始化玩家设置窗口
        this.gameSettingFrame = new GameSettingFrame(this);
        // 初始化玩家记录保存窗口
    ...
    private void setControlConfig() {
        ...
        // 初始化对象输入流
        try (ObjectInputStream objIn = new ObjectInputStream(FileLoadUtil.loadAsStream("data/control.dat"))) {
            // 读取对象
            Map<Integer, String> actionsMap = (HashMap<Integer, String>) objIn.readObject();
            //
            // 将 Map 集合转换为 Set 集合
    ...
    public void showPlayerConfig() {
        // 显示设置窗口
        this.gameSettingFrame.setVisible(true);
    }
    ...
    public void startGame() {
        ...
        this.gameSettingFrame.setVisible(false);
        // 启动游戏
