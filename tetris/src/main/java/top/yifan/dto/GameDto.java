...
import top.yifan.utils.GameFunction;
...
public class GameDto {
     ...
     * 地图行数
     */
    private static final int GAME_ZONE_ROW = GameConfig.getSystemConfig().getMaxY();

    /**
     * 地图列数
     */
    private static final int GAME_ZONE_COL = GameConfig.getSystemConfig().getMaxX();
    ...
    public void initEntityParam() {
        // 初始化游戏地图
        this.gameMap = new boolean[GAME_ZONE_ROW][GAME_ZONE_COL];
        // 初始化分数
        this.newScore = 0;
        // 初始化等级
        this.rank = 0;
