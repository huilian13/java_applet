...
import top.yifan.utils.JdbcUtil;
...
public class DataBase implements Data {
     ...
     * 查询 SQL 语句
     */
    private static final String SELECT_SQL = "SELECT user_name,score FROM user_point where type_id=1 ORDER BY score DESC LIMIT 5";
    ...
    public DataBase(Map<String, String> paramMap) {
        // 获取数据库链接
    ...
    public List<Player> loadData() {
        ...
        try {
            // 获取驱动连接
            connection = JdbcUtil.getConnection(DB_URL, DB_USER, DB_PASSWORD);
            // 预编译SQL语句
