...
import com.kevin.control.NovelCrawlerControl;
...
public class NovelSearchPanel extends JPanel {
    ...
    private void initComponent(){
        //创建标签组件
        JLabel textLabel = new JLabel(new ImageIcon("img/string.png"));
        //创建文本组件
        this.textField = new JTextField(32);
        //设置输入的字体格式
        this.textField.setFont(new Font("宋体",Font.PLAIN,20 ));
        //创建按钮
        this.searchButton = new JButton(new ImageIcon("img/search.png"));
        this.add(textLabel);
        this.add(textField);
        ...
        MouseAdapter mouseAdapter=new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if(e.getButton()==MouseEvent.BUTTON1){
                    ...
                    if(novelName!=null&&!"".equals(novelName.trim())){
